...
interface ApiService {
    ...
    @GET("search?query={temp}?rapidapi-key=564d89b1demshec6f0e210cbdd20p1c252ajsnafddd033c068")
    suspend fun fetchRecipeList(@Path("temp") temp: String): RecipeCollection
