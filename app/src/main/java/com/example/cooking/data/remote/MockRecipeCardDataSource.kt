...
class MockRecipeCardDataSource: RecipeDataSource {
    override suspend fun fetchRecipes(): List<String> = listOf(
        ...
        //"{\"recipeId\":\"One-pot paneer curry pie\",\"name\":\"One-pot paneer curry pie\",\"imageSrc\":\"https://images.immediate.co.uk/production/volatile/sites/30/2020/08/one-pot-paneer-curry-pie-c1bcd2f.jpg\"}",
        "{\"recipeId\":\"Autumn vegetable salad with saffron dressing\",\"name\":\"Autumn vegetable salad with saffron dressing\",\"imageSrc\":\"https://images.immediate.co.uk/production/volatile/sites/30/2020/08/autumn-vegetable-salad-with-saffron-dressing-ff72d14.jpg\"}",
